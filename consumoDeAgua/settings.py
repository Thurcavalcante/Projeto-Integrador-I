"""
Django settings for consumoDeAgua project.
...
SECRET_KEY = 'django-insecure-wl@#5j0%2!u0pu6+l^39l!p4cmwf*y(+5g=#86v0-_ra(sv-8f'
...
ROOT_URLCONF = 'consumoDeAgua.urls'
...
WSGI_APPLICATION = 'consumoDeAgua.wsgi.application'
